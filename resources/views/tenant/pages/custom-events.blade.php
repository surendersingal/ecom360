...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Custom Events</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('tenant.dashboard', $tenant->slug) }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Custom Events</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Custom Events Overview</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted">Track and analyze custom events sent via the SDK.</p>
                    <div class="text-center py-4">
                        <i class="bx bx-bolt-circle text-muted" style="font-size: 48px;"></i>
...
<script>
    new ApexCharts(document.querySelector("#main-chart"), {
        ...
        series: [{ name: 'Custom Events', data: [0,0,0,0,0,0,0] }],
