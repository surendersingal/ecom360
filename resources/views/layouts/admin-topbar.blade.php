        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <i class="bx bx-analyse text-primary" style="font-size:22px"></i>
                    </span>
                    <span class="logo-lg">
                        <span class="text-primary fw-bold" style="font-size:17px">Ecom360</span>
                    </span>
                </a>
                <a href="{{ route('admin.dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <i class="bx bx-analyse text-white" style="font-size:22px"></i>
                    </span>
                    <span class="logo-lg">
                        <span class="text-white fw-bold" style="font-size:17px">Ecom360</span>
                    </span>
                </a>
            </div>
